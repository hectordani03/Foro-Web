<nav class="sidebar">
    <header> 
        <div class="title flex items-center mt-2">
            <a class="" href="<?= URL; ?>">
                <svg class=" w-12 h-12 ml-2 " id="icons" viewBox="0 0 70 70" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 id="forus" class="text-black flex w-full text-2xl font-bold ml-1 mb-1 flex-col text-center sm:flex-row sm:text-start">FOR <span class="text-blue-500 ml-2">US</span></h1>
        </div>
    ...
    <div class="menu-bar">
        <div class="menu">
            <ul class="menu-links">
                ...
                <li class="nav-link">
                    <a class="mt-5 mb-5" href="<?= URL; ?>posts">
                ...
                <div class="sub-menu">
                    <a href="<?= URL; ?>reports/posts" class="text sub-item">Post</a>
