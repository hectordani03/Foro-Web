...
<div id="addCategoryId" class="absolute z-50 flex justify-center w-full mx-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
</div>
...
<section id="content" class="w-full relative md:w-full">
    ...
    <div class="flex flex-col xl:flex-row transition-all relative md:left-24 w-full md:w-10/12 xl:w-11/12">
