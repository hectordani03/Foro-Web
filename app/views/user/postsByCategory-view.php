...
<section id="content" class="w-full relative md:w-full">
    ...
    <main class="flex mt-20 z-30 flex-col lg:flex-row">
        ...
        <!-- OBJETIVE CARD -->
        <a id="objetive-info" class=" mr-10 w-10/12 mx-auto lg:w-2/12 order-first lg:order-last" href="#"><img class="rounded-lg w-64 h-56 mx-auto lg:mb-0 mb-10" src="<?php echo GIFT; ?>obj2.gif" alt=""></a>
