		...
		<div class="lg:w-3/12 w-12-12 rounded-lg bg-gradient-to-t from-slate-100 to-slate-100 mt-7 overflow-auto relative h-auto">
			...
			<ul class=" ml-7 flex lg:flex-col gap-2 lg:absolute">
				<li class="flex w-full gap-5 flex-col lg:flex-row text-center lg:text-start">
					...
					<p class="text-slate-500 w-full font-semibold text-sm mt-1">Zero Hunger</p>
				</li>
				<li class="flex w-full gap-5 flex-col lg:flex-row text-center lg:text-start">
					<img class="rounded-lg w-10 h-10 mx-auto lg:m-0" src="<?php echo CAT_IMG; ?>obj4.png" alt="" class="w-full">
					<p class="text-slate-500 w-full font-semibold text-sm mt-1">Quality Education</p>
				</li>
				<li class="flex w-full gap-5 flex-col lg:flex-row text-center lg:text-start">
					<img class="rounded-lg w-10 h-10 mx-auto lg:m-0" src="<?php echo CAT_IMG; ?>obj13.png" alt="" class="w-full">
					<p class="text-slate-500 w-full font-semibold text-sm mt-1">Climate Action</p>
				</li>
				<li class="flex w-full gap-5 flex-col lg:flex-row text-center lg:text-start">
					<img class="rounded-lg w-10 h-10 mx-auto lg:m-0" src="<?php echo CAT_IMG; ?>obj14.png" alt="" class="w-full">
					<p class="text-slate-500 w-full font-semibold text-sm mt-1">Life Below Water</p>
				</li>
				<li class="flex w-full gap-5 mb-5 flex-col lg:flex-row text-center lg:text-start">
					...
					<p class="text-slate-500 w-full font-semibold text-sm mt-1">Reduced Inequalities</p>
				</li>
			</ul>
		</div>
	</section>
	<section class="flex gap-5 relative flex-col lg:flex-row interact">
			...
			<div class="lg:absolute">
				<ol class="relative border-s border-gray-400 ml-7 mr-4">
					<li class="mb-10 ms-6">
						...
						<div class="activity-cards items-center justify-between p-4 bg-slate-200 border border-gray-200 rounded-lg shadow-sm sm:flex ">
					...
					<li class="mb-10 ms-6">
						...
						<div class="activity-cards p-4 bg-slate-200 border border-gray-200 rounded-lg shadow-sm ">
