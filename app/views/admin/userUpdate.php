    ...
    ?>
        <div class="text-content">
            ...
            <div class="text-center">
                <img src="<?php echo PROF_IMG; ?><?php echo $data["profile_picture"]; ?>" class="profile-img mx-auto recorte" id="preview_image">
            </div>

            <form class="requestForm" id="photoForm" action="<?php echo REQUEST; ?>users/userRequest.php" method="POST" autocomplete="off" enctype="multipart/form-data">
