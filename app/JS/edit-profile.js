  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    editProfile.addEventListener("click", (e) => {
      ...
      <section id="modal" class="bg-gray-100 dark:bg-slate-700 rounded-xl w-6/12 mx-auto relative mt-32">
          ...
          <section class="flex">
              <form class="requestForm" action="http://localhost/For-Us/app/user/requestControllers/users/userRequest.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <p>In order to update the data, please enter your USER and PASSWORD with which you logged in.</p>
  
                  <section class="flex gap-5">
                      <input name="old_user" type="text" placeholder="Current Username" class="border-b-2 border-t-1 border-gray-300 py-3 focus:border-b-2 focus:border-gray-400 transition-colors focus:outline-none bg-inherit bg-slate-200 dark:bg-slate-600 rounded-2 xl px-5 text-gray-400 font-semibold w-5/12 mt-5 shadow-md rounded-xl" pattern="[a-zA-Z0-9]{4,20}" maxlength="20" required />
  
                      <input name="old_pass" type="password" placeholder="Current Password" class="border-b-2 border-t-1 border-gray-300 py-3 focus:border-b-2 focus:border-gray-400 transition-colors focus:outline-none bg-inherit bg-slate-200 dark:bg-slate-600 rounded-2 xl px-5 text-gray-400 font-semibold w-5/12 mt-5 shadow-md rounded-xl" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required />
                  </section>
                          ...
                          <div class="border-2 border-dashed border-blue-500 w-10/12 mx-auto text-center flex flex-col justify-center items-center rounded-xl mb-5 mt-5">
                              <label for="input-file" id="drop-area">
                                  ...
                                  <div id="img-view" class="border-dashed border-2 border-gray-400 p-4 rounded-md text-center">
                                      ...
                                      <svg class="w-20 h-20 mt-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                          <path fill="#3b82f6" d="M144 480C64.5 480 0 415.5 0 336c0-62.8 40.2-116.2 96.2-135.9c-.1-2.7-.2-5.4-.2-8.1c0-88.4 71.6-160 160-160c59.3 0 111 32.2 138.7 80.2C409.9 102 428.3 96 448 96c53 0 96 43 96 96c0 12.2-2.3 23.8-6.4 34.6C596 238.4 640 290.1 640 352c0 70.7-57.3 128-128 128H144zm79-217c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l39-39V392c0 13.3 10.7 24 24 24s24-10.7 24-24V257.9l39 39c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-80-80c-9.4-9.4-24.6-9.4-33.9 0l-80 80z" />
                                      </svg>
  ...
  form.addEventListener("submit", function (e) {
    ...
    Swal.fire({
      ...
      green.addEventListener("click", (e) => {
        if (backgroundClasses.length >= 2) {
          backgroundClasses.replace(
            backgroundClasses.item(1),
            "from-green-400"
          );
        }
      });
