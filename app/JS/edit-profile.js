document.addEventListener('DOMContentLoaded', function() {
    ...
    editProfile.addEventListener('click', e => {
        ...
        <section id="modal" class="bg-gray-100 rounded-xl w-6/12 mx-auto relative mt-32">
        <header class="flex">
            <h1 class="text-black flex justify-start w-full text-2xl font-bold mt-5 ml-5">FOR <span class="text-blue-500 ml-2">US</span></h1>
        ...
        <section class="flex">
            ...
            <h1 class="text-black flex justify-start w-full text-2xl font-bold mt-5 mb-5 ml-5 text-center">Upload your <span class="text-blue-500 ml-2">information</span></h1>
                <section class="flex gap-5">
                    ...
                    type="text"
                    value="Age"
                    class="border-b-2 border-t-1 border-gray-300 py-3 focus:border-b-2 focus:border-gray-400 transition-colors focus:outline-none bg-inherit bg-slate-200 rounded-2 xl px-5 text-gray-400 font-semibold w-5/12 shadow-md"
                    />
                ...
                type="text"
                value="Role"
                class="border-b-2 border-t-1 border-gray-300 py-3 focus:border-b-2 focus:border-gray-400 transition-colors focus:outline-none bg-inherit bg-slate-200 rounded-2 xl px-5 text-gray-400 font-semibold w-5/12 mt-5 shadow-md"
                />               
                <textarea class="relative rounded-lg px-6 py-2 text-lg text-gray-400 bg-slate-200 w-10/12 resize-none outline-none font-semibold mt-10 shadow-md mb-10" rows="7" maxlength="380">Description</textarea>
            </form>
            <section class="w-6/12 flex flex-col items-center mt-10">
            <h1 class="text-black flex justify-center w-full text-2xl font-bold mt-5 ml-5 mb-5">Upload your profile<span class="text-blue-500 ml-2">image</span></h1>

                <div class="w-6/12 shadow-lg mx-auto h-fit rounded-xl bg-slate-200">
                    <div class="border-2 border-dashed border-blue-500 w-10/12 mx-auto text-center flex flex-col justify-center items-center rounded-xl mb-5 mt-5">
                        ...
                        <h1 class="text-black flex justify-center w-full text-xs font-bold mt-1">Drag File Here To Upload</h1>
            ...
            <div class="w-7/12 mt-5">
                <h1 class="text-black flex justify-center w-full text-2xl font-bold mt-5 ">Choose your<span class="text-blue-500 ml-2">Color</span></h1>
