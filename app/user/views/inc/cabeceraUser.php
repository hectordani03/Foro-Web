    ...
    <div id="nav-header" class="bg-gray-200 dark:bg-slate-700 fixed top-0 min-h-screen max-h-screen z-50">
        ...
        <nav id="nav" class="flex flex-col bg-gray-200 dark:bg-slate-700 min-w-24 p-4 justify-start items-center min-h-screen z-50 overflow-x-hidden">
                ...
                <li class="w-15 h-15">
                    <a href="index">
                        <div class="text-gray-400 w-10 h-10 mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path class="fill-current" d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
                            <span class="desplegableText hidden relative left-12 bottom-8">Home</span>
                        </a>
                </div>
            </li>
                <li class="w-15 h-15"><div class="text-gray-400 w-8 h-8 mx-auto cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path class="fill-current" d="M160 80c0-26.5 21.5-48 48-48h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H208c-26.5 0-48-21.5-48-48V80zM0 272c0-26.5 21.5-48 48-48H80c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V272zM368 96h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H368c-26.5 0-48-21.5-48-48V144c0-26.5 21.5-48 48-48z"/></svg>
            ...
            <ul class="flex flex-col gap-7 justify-between mt-5">
                ...
                <li class="w-10 h-10"><a href="#"><img class="rounded-lg" src="./assets/resources/obj2.png" alt="" class="w-full"></a>
                <span class="desplegableText hidden relative left-14 bottom-8 text-gray-400 text-nowrap">Zero Hunger</span>
                </li>
                <li class="w-10 h-10"><a href="#"><img class="rounded-lg" src="./assets/resources/obj4.png" alt="" class="w-full"></a>
                    <span class="desplegableText hidden relative left-14 bottom-8 text-gray-400 text-nowrap">Quality Education</span>
                </li>

                <li class="w-10 h-10"><a href="#"><img class="rounded-lg" src="./assets/resources/obj13.png" alt="" class="w-full"></a>
                    <span class="desplegableText hidden relative left-14 bottom-8 text-gray-400 text-nowrap">Climate Action</span>
                </li>

                <li class="w-10 h-10"><a href="#"><img class="rounded-lg" src="./assets/resources/obj14.png" alt="" class="w-full"></a>
                    <span class="desplegableText hidden relative left-14 bottom-8 text-gray-400 text-nowrap">Life Below Water</span>
                </li>

                <li class="w-10 h-10"><a href="#"><img class="rounded-lg" src="./assets/resources/obj10.png" alt="" class="w-full"></a>
                    <span class="desplegableText hidden relative left-14 bottom-8 text-gray-400 text-nowrap">Reduced Inequalities</span></li>
            ...
            <ul class="flex flex-col gap-7 justify-between mt-5">
                <li class="w-15 h-15"><div class="text-gray-400 w-9 h-9 mx-auto cursor-pointer">
                ...
                <li class="w-15 h-15"><div class="text-gray-400 w-8 h-8 mx-auto cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path class="fill-current" d="M224 0c-17.7 0-32 14.3-32 32V51.2C119 66 64 130.6 64 208v18.8c0 47-17.3 92.4-48.5 127.6l-7.4 8.3c-8.4 9.4-10.4 22.9-5.3 34.4S19.4 416 32 416H416c12.6 0 24-7.4 29.2-18.9s3.1-25-5.3-34.4l-7.4-8.3C401.3 319.2 384 273.9 384 226.8V208c0-77.4-55-142-128-156.8V32c0-17.7-14.3-32-32-32zm45.3 493.3c12-12 18.7-28.3 18.7-45.3H224 160c0 17 6.7 33.3 18.7 45.3s28.3 18.7 45.3 18.7s33.3-6.7 45.3-18.7z"/></svg>
                ...
                <li class="w-15 h-15"><div class="text-gray-400 w-8 h-8 mx-auto cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path class="fill-current" d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zm256-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
            ...
            <div id="privacyId" class="absolute z-10 flex justify-center w-full mx-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <li class="w-15 h-15"><div class="text-gray-400 w-8 h-8 mx-auto cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path class="fill-current" d="M0 80v48c0 17.7 14.3 32 32 32H48 96V80c0-26.5-21.5-48-48-48S0 53.5 0 80zM112 32c10 13.4 16 30 16 48V384c0 35.3 28.7 64 64 64s64-28.7 64-64v-5.3c0-32.4 26.3-58.7 58.7-58.7H480V128c0-53-43-96-96-96H112zM464 480c61.9 0 112-50.1 112-112c0-8.8-7.2-16-16-16H314.7c-14.7 0-26.7 11.9-26.7 26.7V384c0 53-43 96-96 96H368h96z"/></svg>
            ...
            <span class="desplegableText hidden relative left-12 bottom-8 text-gray-400 text-nowrap">Logout</span>
            <hr class="w-full mt-5 border-gray-300 px-10">
...
let scrollPosition = 0;
        ...
        document.getElementById('nav-header').addEventListener('mouseenter', function () {
