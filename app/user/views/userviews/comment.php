<!-- PAGINA DE PRUEBA, ESTRUCTURA DE COMENTARIO, SE BORRARA -->
<section class="bg-gray-100 rounded-xl w-7/12 mx-auto h-auto flex flex-col relative">
    ...
    <div class="overflow-y-auto z-40">
        ...
        <div class="w-10/12 mx-auto">
            ...
            <div class="flex gap-5 mt-10">
                <img class="w-12 h-11 bg-blue-500 rounded-full top-8 left-8" src="/app/assets/person-1.jpg" alt="">
                <div class="rounded-xl bg-gray-200 shadow-lg">
                    <p>dmskdjsdsdskdksssddsdsdsds</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <hr class="w-full mt-5">
    <section class="fixed bottom-0 bg-gray-100 w-7/12 shadow-inner">
