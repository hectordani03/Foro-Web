...
?>
    ...
    <div class="post" data-post-id="<?php echo $post['id_post']; ?>">
        ...
        <div class="bg-gray-100 dark:bg-slate-700 shadow-lg w-full rounded-xl flex flex-col relative mt-5 h-fit self-start opacity-100">
            ...
            <div class="flex mt-5 ml-5">
                <img class="w-12 h-11 bg-blue-500 rounded-full top-8 left-8" src="<?php echo APP_URL; ?>assets/profile_picture/<?php echo $post['profile_picture']; ?>" alt="">
                <div class="flex flex-col ml-5">
                    <h2 class="text-xl text-gray-400 font-semibold"><?php echo $post['username']; ?></h2>
                    <p class="text-gray-400"><?php echo $formatted_time; ?></p>
                </div>
                <!-- CARD MENU -->
            ...
            <!-- CARD CONTENT -->
            <p class="text-gray-400 w-10/12 mx-auto text-xl mt-8"><?php echo $post['content']; ?></p>
            ...
            <div class="flex gap-4 w-10/12 mx-auto mt-5">
                <a class="text-white font-bold bg-gray-400 dark:bg-gray-500 rounded-full px-4 py-1 text-center" href="">#<?php echo $post['category']; ?></a>
            ...
            <div class="flex w-10/12 relative mt-10 mb-5 mx-auto">
                ...
                <div id="share-button" class="text-gray-400 w-8 h-8 absolute right-3 cursor-pointer share-button" data-post-id="<?php echo $post['id_post']; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
