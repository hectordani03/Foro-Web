<?php
$query = $model->run_query("SELECT * FROM posts INNER JOIN user ON posts.id_user = user.id_user");
    ...
    <div class="post">
        ...
        <div class="bg-gray-100 dark:bg-slate-700 shadow-lg w-full rounded-xl flex flex-col relative mt-5 h-fit self-start opacity-100">
            ...
            <div class="flex mt-5 ml-5">
                <img id="profile_picture" class="w-12 h-11 bg-blue-500 rounded-full top-8 left-8" data-post-profpic="<?php echo $post['profile_picture']; ?>" src="<?php echo APP_URL; ?>assets/profile_picture/<?php echo $post['profile_picture']; ?>" alt="">
                <div class="flex flex-col ml-5">
                    <h2 id="username" class="text-xl text-gray-400 font-semibold" data-post-username="<?php echo $post['username']; ?>"><?php echo $post['username']; ?></h2>
                    <p class="text-gray-400" data-post-time="<?php echo $formatted_time ?>"><?php echo $formatted_time; ?></p>
                </div>
                <!-- CARD MENU -->
            ...
            <!-- CARD CONTENT -->
            <p class="text-gray-400 w-10/12 mx-auto text-xl mt-8" data-post-cont="<?php echo $post['content']; ?>"><?php echo $post['content']; ?></p>

            <!-- <a class="text-blue-500 underline text-xl w-10/12 mx-auto mt-2 mb-1" href="https://google.com">Naciones Unidas</a> -->
            <?php if ($post['img'] != "") { ?>
                <img class="w-10/12 mx-auto rounded-xl mt-7" data-post-img="<?php echo $post['img']; ?>" src="<?php echo APP_URL; ?>assets/post_img/<?php echo $post['img']; ?>" alt="">
            <?php } ?>
            <!-- CARD HASHTAGS -->
            <div class="flex gap-4 w-10/12 mx-auto mt-5">
                <a class="text-white font-bold bg-gray-400 dark:bg-gray-500 rounded-full px-4 py-1 text-center" data-post-category="<?php echo $post['category']; ?>" href="">#<?php echo $post['category']; ?></a>
            ...
            <div class="flex w-10/12 relative mt-10 mb-5 mx-auto">
                ...
                <div id="comment-button" class="comment-button text-gray-400 w-7 h-7 ml-5 mt-1 cursor-pointer" data-post-id="<?php echo $post['id_post']; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <?php } else { ?>
                    <div id="" class="nologued text-gray-400 w-8 h-8 absolute right-3 cursor-pointer share-button" disabled>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path class="fill-current" d="M307 34.8c-11.5 5.1-19 16.6-19 29.2v64H176C78.8 128 0 206.8 0 304C0 417.3 81.5 467.9 100.2 478.1c2.5 1.4 5.3 1.9 8.1 1.9c10.9 0 19.7-8.9 19.7-19.7c0-7.5-4.3-14.4-9.8-19.5C108.8 431.9 96 414.4 96 384c0-53 43-96 96-96h96v64c0 12.6 7.4 24.1 19 29.2s25 3 34.4-5.4l160-144c6.7-6.1 10.6-14.7 10.6-23.8s-3.8-17.7-10.6-23.8l-160-144c-9.4-8.5-22.9-10.6-34.4-5.4z" />
                        </svg>
                    </div>
