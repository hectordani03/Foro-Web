...
<head>
    ...
    <style>
        #nav-header{
            ...
            scrollbar-color: #a6a6a6 rgb(229 231 235) ;
        }

        #nav-header::-webkit-scrollbar {
        background-color: rgb(229 231 235);
        }
        #nav-header::-ms-scrollbar {
        background-color: rgb(229 231 235);
        }
    </style>
</head>
    ...
    <div id="nav-header" class="bg-gray-200 fixed top-0 min-h-screen max-h-screen hover:overflow-y-auto z-50">
        ...
        <nav id="nav" class="flex flex-col bg-gray-200 min-w-24 p-4 justify-start items-center min-h-screen z-50">
            ...
            <ul class="flex flex-col gap-7 justify-between mt-5">
                ...
                <li class="w-15 h-15">
                    <a href="index">
                        <div class="text-gray-400 w-7 h-7 mx-auto">
