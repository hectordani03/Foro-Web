        ...
        <main id="background" class="bg-gradient-to-b from-gray-100 rounded-xl w-12/12 h-80 mr-5 ml-5 relative">
            <section class="absolute -bottom-56 left-10 z-50 flex">
                ...
                <div class="relative -bottom-20 flex flex-col text-center justify-start w-3/12">
                    <h1 class="text-3xl font-bold text-gray-600 mb-5 dark:text-white">Jose Joshua</h1>
                    <p class=" text-gray-400 font-normal text-center dark:text-white">"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas est totam quam. Nulla laborum illum tempora? Porro nobis corporis necessitatibus aut, quisquam magni totam neque dolorem, atque hic accusamus ea?"</p>
