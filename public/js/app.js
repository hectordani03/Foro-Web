const app = {
  ...
  allPosts: function () {
    let html = ` <div class=" relative top-32">
  ...
  sharePost: function (postId) {
    ...
    let html = `
          ...
          <section class="bg-gray-100 rounded-3xl w-5/12 mx-auto h-auto flex flex-col relative ">
              <section id="modal2" class="bg-gray-100 dark:bg-slate-700 rounded-3xl w-5/12 mx-auto mt-12 -mb-24 flex flex-col fixed" style="height: 90%;">
                      ...
                      <div class="bg-gray-100 dark:bg-slate-700 w-11/12 rounded-3xl flex flex-col relative  h-fit self-start opacity-100 mx-auto">
                          ...
                          <form class="" id="sharePost-form" method="POST" autocomplete="off" enctype="multipart/form-data">
                              ...
                              <div class="flex gap-4 w-12/12 mx-auto mt-5">
                                  <a class="text-white font-bold bg-gray-400 rounded-full px-4 py-1 text-center">#${post.category}</a>
                                  <input type="hidden" name="category" value="${post.category}"></input>
                              </div>
...
$(function() {
  $(".nologued").on("click", function(event) {
      ...
      Swal.fire({
          ...
          confirmButtonText:'<a class="botoniniciar text-light text-decoration-none" href="/login">Login / Register</a>',
