    ...
    <div class="flex flex-col ml-5">
        ...
        <!-- CARD MENU -->
            <div class="absolute right-5 top-0 h-fit z-50">
                <span id="menu-card" class="text-5xl text-gray-400 cursor-pointer select-none menu-card" onclick="app.menuCard(${
                  post.id
                })">...</span>
            </div>
    </div>
...
`;
      ...
      <img id="profile_picture" class="w-12 h-11 bg-blue-500 rounded-full top-8 left-8" src="http://forus.com/resources/assets/img/profile/${
        post.profilePic
              ...
              <!-- CARD MENU -->
              <div class="absolute right-5 top-0 h-fit z-50">
                  <span id="menu-card" class="text-5xl text-gray-400 cursor-pointer select-none h-fit" onclick="app.menuCard(${
                    post.id
                  })">...</span>
              </div>  
      </div>
